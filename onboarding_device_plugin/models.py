...
# Support NetBox v3.2.5

from netbox.models import NetBoxModel  # pylint: disable=no-name-in-module, import-error


class OnboardingTask(ChangeLoggingMixin, models.Model):
    ...
    class Meta:
        verbose_name_plural = 'OnboardingTask'
    ...
    def get_absolute_url(self):
        ...
        return reverse("plugins:onboarding_device_plugin:onboardingtask", kwargs={"pk": self.pk})


class OnboardingDevice(NetBoxModel, models.Model):
    ...
    class Meta:
        verbose_name_plural = 'OnboardingDevice'
